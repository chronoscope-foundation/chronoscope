...
use crate::external_ids::{WikidataEntityId, WikidataPropertyId};
...
/// [`CommitHashView`](crate::submit) hash input, which flattens the
...
/// resulting [`CommitId`](crate::grammar::ids::CommitId). Types that round-trip
...
///    bytes that flow into the [`CommitId`](crate::grammar::ids::CommitId) hash.
