...
use crate::facts::projection::{
    self, Bookend, Bracket, Citation, Cited, ConsensusConflict, DepictionRecord, FactMap, FactSet,
    MemberLineage, NameKey, NameRecord, RegionRecord, Sameness,
};
...
fn depiction<OtherId, SrcId, ImgId>(
    other: OtherId,
...
mod tests {
    ...
    fn claimed_value<V: Ord + Clone>(value: V, support: Lin) -> Bracket<Claimed<V>, Lin> {
        claim(
            Claimed::Of {
    ...
    fn geometry() -> Result<ImageGeometry, Box<dyn std::error::Error>> {
