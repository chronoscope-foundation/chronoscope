...
//! [`crate::facts::assertions::JudgmentAssertion`]: same-entity,
...
//!   variants on [`crate::facts::submit::SubmitError`].
//!
...
/// like [`crate::facts::submit::EntityIdx`]). The `Debug` rendering works for
